...
description: Specialized sub-agent for SMS verification workflows. Handles full lifecycle — discovery → buy_number → wait_for_code → return OTP — using VirtualSMS MCP tools across 2000+ services and 145+ countries with real physical SIM cards (not VoIP).
tools: ["virtualsms_*"]
---
